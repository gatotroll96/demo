	...
	<div class="m">
		...
		<div class="toolbar-list" id="toolbar">
			...
			<div class="clr"></div>
				...
				<!-- TITLE -->
        <div class="pagetitle icon-48-groups"><h2><?php echo 'Admin Manager: Book' ?></h2></div>
	</div>
</div>
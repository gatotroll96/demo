<?php
    ...
    $linkPublish    = URL::createLink('admin', 'category', 'status', array('type'=>1));
    $buttonPublish  = Helper::createButton('toolbar-publish',$linkPublish, 'Publish', 'icon-32-publish','submit');
    // button cho phần UNpublish
    $linkUnpublish      = URL::createLink('admin', 'category', 'status',array('type'=>0));
	...
	<div class="m">
		...
		<div class="toolbar-list" id="toolbar">
			...
			<div class="clr"></div>
				...
				<!-- TITLE -->
        <div class="pagetitle icon-48-groups"><h2><?php echo 'Admin Manager: Category' ?></h2></div>
	</div>
</div>
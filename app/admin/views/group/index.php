            ...
            <table class="adminlist" id="modules-mgr">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="title" width="20%"><?php echo $sortName; ?></th>
                        ...
                        <th width="15%"><a href="#">Created By</a></th>
                        <th width="10%"><a href="#">Modified</a></th>
                        <th width="15%"><a href="#">Modified By</a>
                ...
                <?php
                    if(!empty($this->items)){
                        ...
                        foreach ($this->items as $key => $value) {
                            ...
                            $linkEdit = URL::createLink('admin', 'group', 'add', array('id'=>$id));
                            $xhtml .=   '<tr class="'.$row.'">
                                            <td class="center">
